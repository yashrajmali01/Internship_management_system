        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <p class="text-center">Incomplete Profile</p>
                ...
                <div class="modal-body text-center mt-3">
                    ...
                    <h4>To find and apply for internships, please Complete Your Profile First</h4>
                    <button class="btn btn-primary mr-5 mt-2" onclick="openAnotherModal2()">
                        Go To Profile
                    </button>
                </div>
            </div>
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <button class="btn btn-primary mt-2" onclick="openAnotherModal2()">Go To Profile</button>
            </div>
