...
<hr>
                    <div class="form-group">
                        <div class="input-group">
                            <label for="location">*KeySkills:</label>
                            <div id="skillsContainer">
                                <!-- Skill input fields will be dynamically added here -->
                            </div>
                            <div class="card-body d-flex justify-content-end">
                                <button class="btn btn-primary btn-sm" style="background-color: rgb(46, 58, 151);" id="addSkillBtn">Add KeySkill</button>
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function(){
        $("#addSkillBtn").click(function(){
            var newSkillField = '<div class="skill-input"><input type="text" class="form-control" name="skill[]" placeholder="Enter Skill"></div>';
...
<div class="card-body d-flex justify-content-end">
<button class="btn btn-primary btn-sm" style="background-color: rgb(46, 58, 151); height:40px;" onclick="addresume('addresume')">Add Resume</button>
</div>
        ...
        <div class="modal-content">
            ...
            <input type="file" class="form-control-file" id="profileImage" name="profileImage">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control"  name="experiance" placeholder="Enter your Experiance">
                    </div>
