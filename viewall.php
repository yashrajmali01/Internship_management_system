...
<body id="back">
    ...
    <div class="container-fluid">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#intro" class="scrollto" >All Company List</a></h1>
      </div>
		
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          <li><a href="http://localhost/Online%20Internship%20Management%20System/">Admin Home</a></li>
          <li><a href="addemployee.php" >Add Company</a></li>
          <li class="menu-active"><a href="viewall.php" >View All Company</a></li>
			<li><a href="leave_main.php">Company Leave Management</a></li>
