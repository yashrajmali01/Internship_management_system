...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <div class="container">
      ...
      <!-- <a class="navbar-brand" href="#intro">New Student Registration</a> -->
...
<br><br>
  <div class="container mt-5">
    <div>
      <h3 style="text-align:center;">Sign-up as a student and apply for free</h3>
      <!-- <p style="text-align:center;">2,50,000+ companies hiring on Internshipgate</p> -->
    </div>
      ...
      <div class="row mt-4">
        <div class="col-md-6">
          ...
          <div class="card-body text-center">
            <img src="https://internshipgate.com/static/media/student-registration.63cc31a8593ae1d72f9f.png" class="img-fluid" alt="Image">
          </div>
            ...
            <div class="card-body">
              ...
              <form action="" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="eid" name="username" placeholder="username" required>
                </div>
                <div class="form-group">

                  <input type="text" class="form-control" id="eid" name="name" placeholder="Full Name" required>
                </div>
                <div class="form-group">

                  <input type="text" class="form-control" id="ename" name="email" placeholder="Email Address" required>
                </div>
                <div class="form-group">

                  <input type="text" class="form-control" id="cname" name="mobile" placeholder="Mobile Number" required>
                </div>
                <div class="form-group">

                  <input type="text" class="form-control" id="cname" name="lastsem" placeholder="Last Semester %" required>
                </div>

                <div class="form-group">

                  <input type="text" class="form-control" id="cname" name="clgcode" placeholder="College Code" required>
                </div>
                <div class="form-group">
  ...
  if (isset($_POST['submit'])) {
    ...
    if (empty($_POST['name']) || empty($_POST['mobile']) || empty($_POST['email']) || empty($_POST['lastsem']) || empty($_POST['gender']) || empty($_POST['username']) || empty($_POST['pass']) || empty($_POST['clgcode'])) {
    ...
    $result = mysqli_query($conn, "insert into student values ('$sname','$mob','','$clgcode','$grade','$gender','$email','$pd','$uname','0','0')") or die("Someting went wrong Failed" . mysqli_error($conn));
    echo "<script>alert('Registration Successful')</script>";
    echo "<script>location.href='studentreg.php'</script>";
  }
